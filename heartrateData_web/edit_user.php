            ...
            <div class="col">
                <div class="card userform">
                    <div class="card-body ">
                        ...
                        if (isset($id)) {
                            echo "<form class='styform' name='form_add' action='./php/update_user.php' method='POST'>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <input type="button" value="Cancel" class="btn btn-danger" style="width:100%;" onClick="document.location.href='index.php';"/>
                            </div>
                            </form>
